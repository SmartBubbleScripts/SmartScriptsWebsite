        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center'>
          <div className='text-center md:text-left'>
            ...
            <p className='mt-3 text-base text-gray-600 dark:text-gray-300 sm:mt-5 sm:text-lg lg:text-xl max-w-xl mx-auto md:mx-0'>
              ...
              decentralized crypto tasks.
            </p>
            <div className='mt-8 sm:mt-10 flex justify-center md:justify-start'>
              <Link
                href='/products'
                className='inline-block px-8 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
              >
                Explore Tools
              </Link>
            </div>
